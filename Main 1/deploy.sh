#!/bin/bash
# deploy.sh - Despliega n8n Main 1 en n8n-nodo1 (10.114.158.71)
# Ejecutar desde WSL, Git Bash o Linux con sshpass instalado

set -e

SERVER_IP="10.114.158.71"
SERVER_USER="administrador"
SERVER_PASS="Temporal01#"
REMOTE_DIR="/opt/n8n-main1"

echo "=== Desplegando n8n Main 1 en $SERVER_IP ==="
...
echo "[5/5] Levantando contenedor n8n Main 1..."
sshpass -p "$SERVER_PASS" ssh -o StrictHostKeyChecking=no "$SERVER_USER@$SERVER_IP" "
    cd $REMOTE_DIR
...
echo ""
echo "=== n8n Main 1 desplegado exitosamente ==="
echo "    Acceso UI: http://10.115.25.101"
